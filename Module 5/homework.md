...
In this homework, I use Bruin to build a complete data pipeline, from ingestion to reporting.

## Setup

1. Installed Bruin CLI: `curl -LsSf https://getbruin.com/install/cli | sh`
2. Initialized the zoomcamp template: `bruin init zoomcamp my-pipeline`
3. Configured my `.bruin.yml` with a DuckDB connection
4. Followed the tutorial in the [main module README](../../../05-data-platforms/)

After completing the setup, I had a working NYC taxi data pipeline.
